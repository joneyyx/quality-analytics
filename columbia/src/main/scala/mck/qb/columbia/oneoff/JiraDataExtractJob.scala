...
object  JiraDataExtractJob extends Job{
  ...
  val JSON_PATH : String ="wasbs://jiradata@cdlstorageuser.blob.core.chinacloudapi.cn/data/Jira_result_100_v2.json"
  val DB : String = "quality_dev_raw"
  val TB : String = "jira_data_raw"
  val SAVE_PATH :String = "wasbs://jiradata@cdlstorageuser.blob.core.chinacloudapi.cn/data/parquet/"
